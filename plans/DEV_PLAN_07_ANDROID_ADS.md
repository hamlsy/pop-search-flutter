...
## 진행 체크
- [x] Android 전용 광고 모듈 통합(`google_mobile_ads`)
- [x] 광고 위치 고정(Settings 하단)
- [x] 고정 높이 컨테이너 적용으로 레이아웃 점프 방지
- [x] 광고 로드 실패 graceful fallback 적용
- [x] 금지사항 준수(검색 입력/Go 주변 금지, 인터스티셜/리워드/스플래시 미사용)
- [x] 광고 정책 검증 체크리스트 작성
